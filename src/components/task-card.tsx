...
const TaskCard = ({ task, updateTask, deleteTask }: TaskCardProps) => {
  ...
  if (editMode) {
    return (
      <div className="bg-main-bg p-2.5 h-[100px] min-h-[100px] flex items-center text-left rounded-xl hover:ring-2 hover:ring-inset hover:ring-rose-500 cursor-grab relative">
        <textarea
